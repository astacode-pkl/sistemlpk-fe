  ...
  <div class="min-h-screen">
    ...
    <div class="h-[25vh] w-full relative mt-20 mb-10 shadow-md flex items-center justify-center">
      <div>
        ...
        <div v-else>
          <img src="assets/img/bg-tentang.webp" alt="foto-bg" class="w-full h-full object-cover absolute inset-0" />
    ...
    <!-- History Section -->
    <div v-observe-visibility="(isVisible) => visibilityChanged('history', isVisible)" class="max-w-6xl mx-auto px-4">
      <h3 :class="[
      ...
      <!-- Curriculum Section -->
      <div v-observe-visibility="(isVisible) => visibilityChanged('curriculum', isVisible)" class="max-w-5xl mx-auto">
        ...
        <div data-aos="fade-up" data-aos-duration="2500"
          class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 px-4">
          <div v-for="(item, index) in curriculumItems" :key="index" class="group" :class="[
            ...
            <div
              ...
              <div class="flex flex-col items-center space-y-4">
                <div
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 md:w-8 h-6 md:h-8 text-blue-600" fill="none"
      ...
      <!-- Licensing Section -->
      <div v-observe-visibility="(isVisible) => visibilityChanged('licensing', isVisible)"
