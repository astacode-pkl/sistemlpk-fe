<template>
  <div>
    ...
    <div class="max-w-7xl mx-auto">
      <h2 class="text-center text-3xl font-bold text-blue-500 mb-3 animate-fade-in" data-aos="fade-up">Galeri</h2>
      ...
      <Foto />
      <p class="text-center text-gray-600 mb-10 animate-fade-in" data-aos="fade-up">Foto Kegiatan Lainnya</p>
    ...
    <div class="max-w-7xl mx-auto mt-14">
      ...
      <div class=" mx-auto h-1 w-16 bg-blue-600 rounded mb-4 mt-4 animate-slide-up" data-aos="fade-up"></div>
      <p class="text-center text-gray-600 mb-10 animate-fade-in" data-aos="fade-up">Program LPK Tsukuba</p>
      <Program />
    </div>
    <div class="max-w-7xl mx-auto mt-14">
      <h2 class="text-center text-3xl font-bold text-blue-500 mb-3 animate-fade-in" data-aos="fade-up">Proses ke jepang
      </h2>
      <div class=" mx-auto h-1 w-16 bg-blue-600 rounded mb-4 mt-4 animate-slide-up" data-aos="fade-up"></div>
      <p class="text-center text-gray-600 mb-10 animate-fade-in" data-aos="fade-up">Langkah langkah sebelum ke jepang
      </p>
      <Step />
    </div>
    <Kontak />
