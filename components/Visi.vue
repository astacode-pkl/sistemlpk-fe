            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 w-full max-w-7xl">
                ...
                <div class="p-10 bg-gray-50 shadow-lg rounded-lg mx-auto col-span-1 md:col-span-2 md:order-1 order-2" data-aos="fade-up">
                    ...
                    <p class="mt-4 text-gray-700 leading-relaxed">
                        ...
                        Pekerja
                        Berketerampilan Khusus.<br>
                        3. Mendidik dan melatih bahasa Jepang dengan didampingi instruktur/pengajar alumni magang Jepang
                        yang
                        profesional dan berpengalaman.<br>
                        4. Mempersiapkan calon peserta dalam menghadapi seleksi/ujian yang dilaksanakan oleh
