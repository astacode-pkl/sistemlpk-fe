...
<template>
  <div class="galeri">
    ...
    <div
      class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mb- lg:grid-cols-4 gap-4 sm:gap-6 items-start mx-3 sm:mx-5 mt-5 mb-3">
      <div v-for="(image, index) in images" :key="image.id"
        class="group relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300 h-full"
